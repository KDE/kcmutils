...
public:
    ...
    /**
     * Add plugins to the model. This will not replace existing entries but append to them.
     *
    ...
    /**
     * Emitted when the enabled state matching the default changes.
     *
     * @see defaults
     */
    ...
    /**
     * Emitted when @see isSaveNeeded changed.
     */
